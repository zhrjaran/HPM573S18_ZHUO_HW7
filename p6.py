...
import p5_CalibrationSettings as P
...
print("The Projection interval becomes a little bit smaller when using large sample size \n"
      "however, the change is not obvious")