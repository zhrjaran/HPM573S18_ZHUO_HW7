...
class Cohort:
    ...
    def get_survival_percentage(self):
        """
        :return: return the percentage of people survived beyond 5 years
        """
        for i in range(0,len(self._survivalTimes)):
            if self._survivalTimes[i] > 5:
                self._survivalnum +=1
        return self._survivalnum*100/self._initialPopSize
...
class MultiCohort:
    ...
    def __init__(self, ids, pop_sizes, mortality_probs):
        ...
        self._survivalRates5y = []    # list of survival percentage for each simulated cohort
    ...
    def simulate(self, n_time_steps):
        ...
        for i in range(len(self._ids)):
            ...
            # store survival percentage for each simulated cohort
            self._survivalRates5y.append(cohort.get_survival_percentage())
    ...
    def get_cohort_survival_percentages (self, cohort_index):
        return self._survivalRates5y[cohort_index]

    def get_survival_percentages(self):
        return self._survivalRates5y
